...
template <typename T> class grid2d {
  ...
  grid2d(const grid2d &other) noexcept = default;       // for copy
  grid2d(grid2d &&other) = default;                     // for move
  grid2d() noexcept = default;                          // default constructor
  ~grid2d() noexcept = default;                         // destructor
  grid2d &operator=(grid2d &&other) noexcept = default; // for move
  grid2d &operator=(const grid2d &other) noexcept = default; // for copy
