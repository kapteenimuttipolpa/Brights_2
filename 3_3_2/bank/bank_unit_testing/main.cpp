...
int main()
{
    ...
    while (true)
    {
        ...
        {
            BankAccount account;
            account.create_account(account, all_accounts_);
        }
        ...
        else if (user_input == "3")
        {
            ...
            if (current_account != nullptr)
            {
                ...
                try{
                    current_account->save_money(money, all_accounts_);
                }
        ...
        else if (user_input == "4")
        {
            ...
            if (current_account != nullptr)
            {
                ...
                try{
                    current_account->take_money(money, all_accounts_);
                }
                catch(std::invalid_argument const &e){
                    std::cout << "Exception: " << e.what();
                    continue;
        ...
        {
            current_account->manage_other_account(current_account, all_accounts_);
        }
